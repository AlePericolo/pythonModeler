...
class WriterAPIClass:
    ...
    def __importModel(self):
        return "require_once '" + self.table.title() + "_Model.php';\n"

    # ------------------------------------------------------------------------------------------------------------------

    def __initClass(self):
        return 'class ' + self.table.title() + ' extends ' + self.table.title() + '_Model {\n'
    ...
    def __costructor(self):
        ...
        app += '\tparent::__construct($conn);' + self.format
        app += '}\n'
        return app
